...
/* UsersNewsletter Test cases generated on: 2011-08-12 16:28:53 : 1313159333*/
App::import('Model', 'UsersNewsletter');

class UsersNewsletterTestCase extends CakeTestCase {
	var $fixtures = array('app.users_newsletter', 'app.user', 'app.group', 'app.media', 'app.comment', 'app.post', 'app.users_post', 'app.newsletter');
